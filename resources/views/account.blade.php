...
<main>
                  ...
                  <div class="cp-cart-table mb-50">
                     <table class="table">
                        ...
                        <tbody>
                           ...
                           <tr>
                              <td>
                                 <a href=""><img src="assets/img/product/product-06.png" alt="product">{{
                                    $pt->produit->nom }}</a>
                              </td>
                           ...
                           @empty
                            <tr>
                                 ...
                                 <a href="{{ route('home') }}" class="cp-btn" style="background: red;margin-bottom: 10px;">Retourner vers l'accueil</a>
   ...
   <div class="cp-floating-area d-none d-md-block zi-1100 p-relative ">
      <div class="cp-floating-action cp-bg-move-y">
         <span class="cp-floating-btn cp-floating-phone-btn cp" data-bs-toggle="modal" data-bs-target="#phonePopup"><i
