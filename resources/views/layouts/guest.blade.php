                    ...
                    <div class="cp-header2-top-wrap d-flex align-items-center justify-content-between">
                        <div class="cp-header2-top-item">
                            <div class="cp-header2-info">
                                <ul>
                                    <li><a href="tel:+243972433562"><i class="far fa-phone-alt"></i>+243 972 433 562</a>
                                    </li>
                                    <li><a href="mailto:contact@bamservices.org"><i
                                                class="far fa-envelope"></i>contact@bamservices.org</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="container-fluid">
                    <div class="cp-header2-bottom-wrap">
                        <div class="cp-header2-bottom-item">
                            <div class="logo">
                                <a href="{{ route('home') }}"><img src="{{ asset('assets/img/logo/logo-noir.png') }}"
                                        alt="logo" width="80"></a>
                            </div>
                        </div>
                                ...
                                <div class="d-none d-md-block">
                                    <ul>
                                        ...
                                        <li><a href="{{ route('cart') }}"><i
                                                    class="fas fa-cart-plus"></i><span>{{$panier->count() }}</span></a>
                                        </li>
                                        @endif
                            ...
                            <div class="cp-floating-text">
                                ...
                                <div class="cp-floating-text-inner">
                                    ...
                                    <span class="cp-floating-text-inner-text">
                                        <a target="_blank"
                                            href="https://www.google.com/maps/@38.8938672,-77.0846157,12z">1234, Av.
                                            Lorem, Q/ Ipsum</a>
                                    </span>
                                </div>
                                <div class="cp-floating-text-inner">
                                    ...
                                    <span class="cp-floating-text-inner-text">
                                        <a target="_blank"
                                            href="https://www.google.com/maps/@1.952577,44.3912535,3z">5678, Av. Dolor,
                                            Q/ Sit amet</a>
                                    </span>
                                </div>
                            </div>
                    ...
                    <div class="row">
                            ...
                            <div class="cp-footer2-widget mb-60">
                                <div class="logo mb-20">
                                    <a href="{{ route('home') }}"><img
                                            src="{{ asset('assets/img/logo/logo-white.png') }}" alt="logo"
                                            width="200"></a>
                                </div>
                        ...
                        <div class="col-xxl-2 col-xl-3 col-lg-3 col-md-3">
                            <div class="cp-footer2-widget mb-60">
                                ...
                                <p class="mb-25">Recevez les dernières nouvelles, les événements et plus encore dans
                                ...
                                <div class="cp-footer2-subscribe p-relative mb-35">
                                    <form action="#">
                                        ...
                                        <button class="cp-footer2-subscribe-btn" type="submit"><i
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="cp-copy2-text">
                                <p>Copyright {{ date('Y') }} BAM Services | Design By <a target="_blank"
                                        href="https://silasmas.com">SDEV</a></p>
                            </div>
                        </div>
